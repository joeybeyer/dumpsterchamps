...
export const metadata: Metadata = {
  ...
  description:
    "Discover exactly what fits in a 20 yard dumpster: 6-8 pickup truck loads, 2 tons of debris. See real examples for renovations, roofing, cleanouts & more.",
  openGraph: {
    title: "20 Yard Dumpster Capacity Guide [2026]",
...
const quickFacts = [
  ...
  { label: "Weight Limit", value: "2 tons (4,000 lbs)", icon: Scale },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer: "A 30 yard dumpster holds 50% more volume (30 vs 20 cubic yards) and typically includes 1 more ton of weight allowance (3 tons vs 2 tons). The footprint is similar (same length and width), but the 30-yard is about 1.5 feet taller. The price difference is usually $100 ($595 vs $695).",
  },
];

export default async function TwentyYardCapacity({ params }: PageProps) {
  ...
  return (
    <>
      ...
      <section className="py-16 bg-primary-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">
            $595 flat rate includes delivery, pickup, 7-day rental, and 2 tons of weight. No hidden fees.
          </p>
      ...
      <ArticleSchema
        ...
        description="Discover exactly what fits in a 20 yard dumpster: 6-8 pickup truck loads, 2 tons of debris. See real examples for renovations, roofing, cleanouts & more."
