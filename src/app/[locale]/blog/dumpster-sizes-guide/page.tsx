...
const faqs = [
  ...
  },
  {
    ...
    answer: "Weight allowances are: 10-yard (1 ton), 15-yard (1 ton), 20-yard (2 tons), 30-yard (3 tons), and 40-yard (4 tons). Exceeding your weight allowance incurs overage fees of $75 per ton. Heavy materials like concrete, brick, and roofing shingles can hit weight limits before filling the volume.",
  },
];

export default async function DumpsterSizesGuide({ params }: PageProps) {
