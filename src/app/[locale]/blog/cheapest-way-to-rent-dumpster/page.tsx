...
const pricingComparison = [
  { size: "10 Yard", ourPrice: "$495", typical: "$350-550", includes: "1 ton, 7 days" },
  { size: "15 Yard", ourPrice: "$550", typical: "$400-600", includes: "1 ton, 7 days" },
  { size: "20 Yard", ourPrice: "$595", typical: "$450-700", includes: "2 tons, 7 days" },
  { size: "30 Yard", ourPrice: "$695", typical: "$550-800", includes: "3 tons, 7 days" },
  { size: "40 Yard", ourPrice: "$795", typical: "$650-950", includes: "4 tons, 7 days" },
];
...
export default async function CheapestDumpsterRental({ params }: PageProps) {
