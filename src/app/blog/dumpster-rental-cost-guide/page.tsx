...
import { ChevronRight, Check, AlertTriangle, DollarSign, Shield, X } from "lucide-react";
...
const pricingTable = [
  { size: "10 Yard", price: "$495", weight: "2 tons", rental: "7 days", bestFor: "Small cleanouts, bathroom remodels" },
  { size: "15 Yard", price: "$550", weight: "2.5 tons", rental: "7 days", bestFor: "Medium projects, garage cleanouts" },
  { size: "20 Yard", price: "$595", weight: "3 tons", rental: "7 days", bestFor: "Kitchen remodels, roofing (Most Popular)" },
  { size: "30 Yard", price: "$695", weight: "4 tons", rental: "7 days", bestFor: "Major renovations, construction" },
  { size: "40 Yard", price: "$795", weight: "5 tons", rental: "7 days", bestFor: "Commercial, large demolition" },
];
...
const includedItems = [
  ...
  { item: "Weight Allowance", description: "2-5 tons depending on size" },
...
const faqs = [
  ...
  },
  {
    ...
    answer: "A transparent dumpster rental price should include: delivery to your location, pickup when finished, rental period (typically 7 days), weight allowance (2-5 tons depending on size), disposal/landfill fees, and ideally driveway protection. Be wary of quotes that don't clearly state what's included.",
  },
  {
