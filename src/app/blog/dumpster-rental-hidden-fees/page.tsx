...
const hiddenFees = [
  {
    ...
    description: "The #1 surprise fee. Most rentals include a weight limit (2-5 tons depending on size). Exceed it, and you pay per-ton overages.",
    howToAvoid: [
...
const comparisonTable = [
  ...
  { fee: "Weight (3 tons)", transparent: "Included", hidden: "2 tons, then $75/ton" },
...
const faqs = [
  {
    ...
    answer: "Weight overage fees are the most common surprise. Most dumpsters include 2-5 tons of weight. Exceed this and you'll pay $50-100 per ton over. Heavy materials like concrete, brick, and roofing shingles can easily push you over the limit even if the dumpster isn't full.",
  },
  {
