...
export function SizeCard({
  ...
  return (
    ...
    >
      ...
      <div className="mb-4">
        <p className="text-sm text-secondary-600 text-center mb-2">{capacity}</p>
      </div>
      ...
      <div className="mt-4 pt-4 border-t border-secondary-100">
        <span className="block text-center text-primary-600 font-semibold text-sm hover:text-primary-700">
          View Details →
        </span>
      </div>
    </Link>
