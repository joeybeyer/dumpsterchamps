...
export function Footer() {
  ...
  const footerLinks = {
    ...
    resources: [
      { name: t("footer.costGuide"), href: "/how-much-does-dumpster-rental-cost" },
      { name: t("footer.sizeGuide"), href: "/what-size-dumpster-do-i-need" },
      { name: t("footer.permitGuide"), href: "/do-i-need-permit-for-dumpster" },
      { name: t("footer.sizeCalculator"), href: "/calculator" },
      { name: t("footer.pricing"), href: "/dumpster-rental-prices" },
    ],
    company: [
      ...
      { name: t("footer.termsOfService"), href: "/tos" },
      { name: t("footer.sitemap"), href: "/sitemap-html" },
    ],
  };
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-4">
              <a
                href="https://facebook.com/dumpsterchamps"
                target="_blank"
              ...
              <a
                href="https://instagram.com/dumpsterchamps"
                target="_blank"
                rel="noopener noreferrer"
                className="text-secondary-300 hover:text-primary-400 transition-colors"
              ...
              <a
                href="https://twitter.com/dumpsterchamps"
                target="_blank"
                rel="noopener noreferrer"
                className="text-secondary-300 hover:text-primary-400 transition-colors"
              ...
              <a
                href="https://linkedin.com/company/dumpsterchamps"
                target="_blank"
                rel="noopener noreferrer"
                className="text-secondary-300 hover:text-primary-400 transition-colors"
              ...
              <a
                href="https://youtube.com/@dumpsterchamps"
                target="_blank"
                rel="noopener noreferrer"
                className="text-secondary-300 hover:text-primary-400 transition-colors"
              ...
              <a
                href="https://tiktok.com/@dumpsterchamps"
                target="_blank"
                rel="noopener noreferrer"
                className="text-secondary-300 hover:text-primary-400 transition-colors"
          ...
          {/* Sizes */}
          <div>
            <h3 className="text-lg font-semibold mb-4">{t("footer.sizes")}</h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4">{t("footer.helpfulGuides")}</h3>
            <ul className="space-y-2">
        ...
        <div className="border-t border-secondary-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-secondary-400 text-sm">
            &copy; {new Date().getFullYear()} Dumpster Champs. {t("footer.allRightsReserved")}
          </p>
          <div className="flex gap-4 text-sm text-secondary-400">
            <Link href="/tos" className="hover:text-primary-400">
