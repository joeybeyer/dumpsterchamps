...
// IMPORTANT: No company names, logos, or text on trucks/equipment - keep generic/unbranded
const BRAND_STYLE = `bright orange roll-off dumpster, professional commercial photography, sunny day with clear blue sky, high quality, sharp detail, realistic, NO TEXT on trucks or equipment, NO company logos, generic unbranded delivery truck`;
const WORKER_STYLE = `worker wearing plain orange safety vest and hard hat, NO company logos`;
